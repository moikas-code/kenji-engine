        ...
        >
            {showHeader && (
                ...
                >
                    ...
                    >
                        ┌─ {title} {"─".repeat(Math.max(0, width - title.length -10))}┐
                    </text>
                    {subtitle && (
                        <text
                            style={{
            ...
            >
                {footerContent || (
                    ...
                    >
                        * Required fields • Tab/Shift+Tab Navigate • Enter Next • {submitShortcut}{" "}
                        {submitLabel} {onCancel ? "• ESC Cancel" : ""}
                    </text>
                )}
            </group>
            <group
                    ...
                    {memoizedFields.map((field, index) => (
                        ...
                        >
                            ...
                            >
                                <text
                                    style={{
                                        fg: fieldErrors[field.id] ? "#FF453A" : themeColors.hex.accent,
                                    }}
                                >
                                    {field.label}
                                    {field.required ? " *" : ""}
